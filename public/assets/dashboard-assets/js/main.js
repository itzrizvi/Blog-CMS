...
// Magic Suggest
$(function () {
	$('#magicsuggestBlogCat').magicSuggest();
	$('#magicsuggestBlogTag').magicSuggest();
	$('#magicsuggestNewsTag').magicSuggest();
	$('#magicsuggestNewsCat').magicSuggest();
	$('#magicsuggestCatParnt').magicSuggest();
